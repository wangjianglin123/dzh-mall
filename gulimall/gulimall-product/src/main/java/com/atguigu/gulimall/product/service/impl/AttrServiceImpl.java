...
//        relationDao.delete(new QueryWrapper<>().eq("attr_id",1L).eq("attr_group_id",))
        //
    ...
    public PageUtils getNoRelationAttr(Map<String, Object> params, Long attrgroupId) {
        //1.当前分组只能关联自己所属得分类里面得所有属性
        AttrGroupEntity attrGroupEntity = attrGroupDao.selectById(attrgroupId);
        Long catelogId = attrGroupEntity.getCatelogId();  //得到catelog_id=255
